...
interface SuratKeteranganPDFProps {
  data: SuratKeterangan;
}

export const SuratKeteranganPDFDocument: React.FC<SuratKeteranganPDFProps> = ({
  data,
}) => {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Document Title */}
        <Text style={styles.documentTitle}>SURAT KETERANGAN</Text>
        ...
        <View style={styles.content}>
          ...
          {/* Keterangan Section */}
          <View style={styles.keteranganList}>
            <Text style={styles.sectionTitle}>Keterangan :</Text>
            {data.data.keterangan.map((item, index) => (
              <View key={index} style={styles.keteranganItem}>
                <Text style={styles.keteranganNumber}>{index + 1}.</Text>
                <Text style={styles.keteranganText}>{item}</Text>
              </View>
            ))}
          </View>
