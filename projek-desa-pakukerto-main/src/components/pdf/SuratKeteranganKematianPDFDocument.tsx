...
import { SuratKeteranganKematian } from "@/schemas/surat-keterangan-kematian.schema";
...
interface SuratKeteranganKematianPDFProps {
  data: SuratKeteranganKematian;
}

export const SuratKeteranganKematianPDFDocument: React.FC<
  SuratKeteranganKematianPDFProps
> = ({ data }) => {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Document Title */}
        <Text style={styles.documentTitle}>SURAT KETERANGAN KEMATIAN</Text>
        <Text style={styles.documentNumber}>
          Nomor : {data.nomorSurat || "470/    /424.320.2002/2025"}
        </Text>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>Berdasarkan laporan dari :</Text>
          ...
          <View style={styles.dataSection}>
            <View style={styles.dataRow}>
              ...
              <Text style={styles.dataValue}>{data.data.namaPelapor}</Text>
            </View>
            <View style={styles.dataRow}>
              <Text style={styles.dataLabel}>NIK</Text>
              <Text style={styles.dataColon}>:</Text>
              <Text style={styles.dataValue}>{data.data.nikPelapor}</Text>
            </View>
            <View style={styles.dataRow}>
              <Text style={styles.dataLabel}>Alamat</Text>
              <Text style={styles.dataColon}>:</Text>
              <Text style={styles.dataValue}>{data.data.alamatPelapor}</Text>
            </View>
            <View style={styles.dataRow}>
              <Text style={styles.dataLabel}>Status Pelapor</Text>
              <Text style={styles.dataColon}>:</Text>
              <Text style={styles.dataValue}>{data.data.statusPelapor}</Text>
            </View>
          </View>
          ...
          <View style={styles.dataSection}>
            ...
            <View style={styles.dataRow}>
              <Text style={styles.dataLabel}>Nomor Kartu Keluarga</Text>
              <Text style={styles.dataColon}>:</Text>
            ...
            <View style={styles.dataRow}>
              ...
              <Text style={styles.dataColon}>:</Text>
              <Text style={styles.dataValue}>Indonesia</Text>
            </View>
            <View style={styles.dataRow}>
          ...
          <Text style={styles.paragraph}>Telah meninggal dunia pada :</Text>
          ...
          <View style={styles.dataSection}>
            <View style={styles.dataRow}>
              ...
              <Text style={styles.dataColon}>:</Text>
              <Text style={styles.dataValue}>
                {formatDate(data.data.hariTanggalMeninggal)}
              </Text>
            </View>
            <View style={styles.dataRow}>
              <Text style={styles.dataLabel}>Tempat kematian</Text>
              <Text style={styles.dataColon}>:</Text>
              <Text style={styles.dataValue}>
                {data.data.desaKematian}, {data.data.kecamatanKematian},{" "}
                {data.data.kabupatenKematian}, {data.data.provinsiKematian}
              </Text>
            </View>
            <View style={styles.dataRow}>
              <Text style={styles.dataLabel}>Sebab kematian</Text>
              <Text style={styles.dataColon}>:</Text>
              <Text style={styles.dataValue}>{data.data.sebabKematian}</Text>
            </View>
          </View>

          <View style={styles.content}>
            <Text style={styles.paragraph}>
              Surat keterangan ini digunakan untuk {data.data.keperluan}
            </Text>
            <Text style={styles.paragraph}>
