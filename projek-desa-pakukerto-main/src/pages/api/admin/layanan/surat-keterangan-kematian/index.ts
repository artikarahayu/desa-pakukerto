...
import { updateSuratKeteranganKematianSchema } from "@/schemas/surat-keterangan-kematian.schema";
import {
...
export default async function handler(
  ...
  try {
    ...
    if (req.method === "GET") {
      try {
        ...
        let query = db
          ...
          .where("jenisSurat", "==", "surat-keterangan-kematian");
        ...
        console.error("Error fetching surat keterangan kematian:", error);
        return res
          .status(500)
    ...
    if (req.method === "PUT") {
      ...
      const validationResult = updateSuratKeteranganKematianSchema.safeParse(req.body);
