...
import { updateSuratKeteranganSchema } from "@/schemas/surat-keterangan.schema";
import {
...
export default async function handler(
  ...
  try {
    ...
    if (req.method === "GET") {
      try {
        ...
        let query = db
          ...
          .where("jenisSurat", "==", "surat-keterangan");
    ...
    if (req.method === "PUT") {
      ...
      const validationResult = updateSuratKeteranganSchema.safeParse(req.body);
