...
import { createSuratIzinKeramaianSchema } from "@/schemas/surat-izin-keramaian.schema";
...
export default async function handler(
  ...
  try {
    ...
    const validationResult = createSuratIzinKeramaianSchema.safeParse(req.body);
    ...
    console.error("Error creating surat izin keramaian:", error);
