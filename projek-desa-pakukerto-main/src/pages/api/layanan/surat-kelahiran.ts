...
import { createSuratKelahiranSchema } from "@/schemas/surat-kelahiran.schema";
...
export default async function handler(
  ...
  try {
    ...
    const validationResult = createSuratKelahiranSchema.safeParse(req.body);
    ...
    console.error("Error creating surat kelahiran:", error);
