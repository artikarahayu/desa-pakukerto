...
export default function SuratKeteranganDetailPage() {
  ...
  // Query to fetch single surat keterangan
  const {
    data: surat,
    isLoading,
    error,
  } = useQuery({
    queryKey: ["surat-keterangan", id],
    queryFn: async () => {
      if (!id || typeof id !== "string") return null;

      // Get all surat and find the specific one by ID
      const allSurat = await suratKeteranganApi.getAll();
  ...
  const updateMutation = useMutation({
    mutationFn: ({ data }: { data: any }) =>
      suratKeteranganApi.update(id as string, data),
    onSuccess: () => {
  ...
  return (
    <AdminLayout>
      <Link href="/admin/layanan/surat-keterangan">
      ...
      <div className="space-y-6 mt-2">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:items-center justify-between">
          <div className="flex items-center gap-4">
            <div>
              <h1 className="text-2xl font-bold">Detail Surat Keterangan</h1>
          ...
          <div className="flex gap-2">
            ...
            {surat.nomorSurat && (
              <PDFDownloadLink
                document={<SuratKeteranganPDFDocument data={surat} />}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Daftar keterangan yang diperlukan</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              {surat.data.keterangan.map((item, index) => (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tujuan pengajuan surat keterangan</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Dialog open={isEditStatusOpen} onOpenChange={setIsEditStatusOpen}>
          <DialogContent className="max-w-[400px]">
            <DialogHeader>
              <DialogTitle className="max-w-[400px]">
